...
<%@page import="com.thesquad.dao.PublisherEmailDAO"%>
<%@page import="com.thesquad.models.PublisherEmailModel"%>
<%@page import="com.thesquad.dao.PublisherPhoneDAO"%>
<%@page import="com.thesquad.models.PublisherPhoneModel"%>
<%@page import="java.util.List"%>
<%@page import="com.thesquad.models.CountryModel"%>
<%@page import="com.thesquad.dao.CountryDAO"%>
<%@page import="com.thesquad.dao.CountryDAO"%>
<%@page import="com.thesquad.dao.ProvinceDAO"%>
<%@page import="com.thesquad.models.ProvinceModel"%>
<%@page import="com.thesquad.dao.MunicipalityDAO"%>
<%@page import="com.thesquad.models.MunicipalityModel"%>
<%@page import="com.thesquad.dao.CommuneDAO"%>
<%@page import="com.thesquad.models.CommuneModel"%>
<%@page import="java.time.format.DateTimeFormatter"%>
<%@page import="com.thesquad.dao.AddressDAO"%>
<%@page import="com.thesquad.models.AddressModel"%>
<%@page import="com.thesquad.dao.PublisherDAO"%>
<%@page import="com.thesquad.models.PublisherModel"%>
